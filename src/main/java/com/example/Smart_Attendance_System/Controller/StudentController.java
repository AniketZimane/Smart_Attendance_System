...
//    StudentRepo studentRepo;
    ...
    public String submitData(Model model, Student stu, MultipartFile file) throws MessagingException, UnsupportedEncodingException {
        ...
        if(listStudentExisting.isEmpty())
        {
            ...
            String mailContent="<center><center><h1>Welcome to Innovative THings</h1><br><p>Your Registration Completed successfully</p><br><a href='https://localhost:8080/student/login/'>Student Login<a/>";
